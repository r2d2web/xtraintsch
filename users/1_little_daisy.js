module.exports = {
  "0901": {
    name: "Estel Asabea Agudey",
    password: "0257837111",
    info: "",
    image: "images/profiles/no_image.png",
    showExtraDiv: false,
    links: [
      { label: "My Profile", url: "https://example.com/1" },
    ],
    gallery: {
      term1: ["images/reports/term1/little_daisy/estel.png"],
      term2: [],
      term3: []
    },
    customHTML: {
      term1: `
      <div style="page-break-after: always; margin-bottom: 50px; background-color:white; border-radius:20px; padding: 13px">
        <div class="center">
          ...
          <h3 class="red">SECOND TERM BILL FOR LITTLE DAISY</h3>
        </div>

        <div style="margin-top: 40px;">
          <p style="text-align:left;"><span class="bold">NAME OF CHILD:</span> Estelle A. Agudey</p>
          <p style="text-align:left;"><span class="bold">SCHOOL FEES</span> = 250.00</p>
          <p style="text-align:left;"><span class="bold">FEEDING FEE</span> = 399.00</p>
          <p style="text-align:left;"><span class="bold">EXAMS</span> = 20.00</p>
          <p style="text-align:left;"><span class="bold">ARREARS</span> = 0.00</p>
        </div>

        <div class="bill-box">
          <p><h2 class="bold">TOTAL</h2></p>
          <h2><strong>GH₵ 669.00</strong></h2>
        </div>
        ...
        <div style="clear: both; margin-top: 50px;">
          ...
          <ol>
            ...
            <li>This terms P.T.A. comes off on the 18th of January, 2026, at 2:00 o'clock at the school's premises. Failure to attend will cost you a fine.</li>
          </ol>
          <p>Thank you.</p>
        </div>
      </div>
  ...
  "0902": {
    ...
    gallery: {
      term1: ["images/reports/term1/little_daisy/lady.png"],
      term2: [],
      term3: []
    },
    customHTML: {
      ...
      <div style="page-break-after: always; margin-bottom: 50px; background-color:white; border-radius:20px; padding: 13px">
        ...
        <div style="margin-top: 40px;">
          <p style="text-align:left;"><span class="bold">NAME OF CHILD:</span> Lady Reign Buekie</p>
          <p style="text-align:left;"><span class="bold">SCHOOL FEES</span> = 250.00</p>
          <p style="text-align:left;"><span class="bold">FEEDING FEE</span> = 399.00</p>
          <p style="text-align:left;"><span class="bold">EXAMS</span> = 20.00</p>
          <p style="text-align:left;"><span class="bold">ARREARS</span> = 0.00</p>
  ...
  "0903": {
    ...
    gallery: {
      term1: ["images/reports/term1/little_daisy/oppong.png"],
      term2: [],
      term3: []
    },
    customHTML: {
      ...
      <div style="page-break-after: always; margin-bottom: 50px; background-color:white; border-radius:20px; padding: 13px">
        ...
        <div style="margin-top: 40px;">
          <p style="text-align:left;"><span class="bold">NAME OF CHILD:</span> Alexandar O. Tawiah</p>
          <p style="text-align:left;"><span class="bold">SCHOOL FEES</span> = 150.00</p>
          <p style="text-align:left;"><span class="bold">FEEDING FEE</span> = 399.00</p>
          <p style="text-align:left;"><span class="bold">EXAMS</span> = 20.00</p>
          <p style="text-align:left;"><span class="bold">ARREARS</span> = 0.00</p>
        </div>
  ...
  "user1": {
    ...
    customHTML: {
      ...
      <h1>Terminal Report</h1>
        <h2>Cadman Ampoma Tandoh (Position: 2 out of 2)</h2>
        <p>Class: Daffodils</p>
        <p>Vacation Date: 18th December 2025</p>
        <p>Reopen Date: date </p>
        <p>House: 2025, Attendance: 105 days out of 69</p>
